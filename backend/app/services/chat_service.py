...
async def call_llm(bot: Bot, query: str, thread_id: str) -> str:
    ...
    if bot.provider == "openai":
        ...
        return await call_openai_compatible(bot.provider, bot.model, api_key, bot.system_prompt, query)
...
async def call_openai_compatible(provider: str, model: str, api_key: str, system: str, query: str) -> str:
    base_urls = {
